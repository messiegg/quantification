...
- WARN | RG-005 | combined_v2 RC hash-only verification | actual=PASS=20 WARN=10 FAIL=0 | evidence=scripts/verify_combined_v2_rc.py --mode hash-only | CI 只验证 manifest/hash/已提交小型报告，不重跑完整回测。
