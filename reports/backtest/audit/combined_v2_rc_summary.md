...
- 当前严谨结果: 年化 7.14%，累计 21.96%，最大回撤 -9.36%，夏普 0.78，成交 76，平均日仓位 46.98%，最大持仓数 20。
...
- sensitivity: near_zero 0/14，under_baseline 0/14

## control baseline 结果

- v2 是否优于 universe equal weight: 是。
- v2 是否优于 top score monthly: 是。
- v2 是否优于 random placebo: percentile 96.0%。
