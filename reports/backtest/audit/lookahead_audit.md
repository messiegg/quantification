...
- 确认违规条数: 0
- 估值分位抽样: 20 条，失败 0 条
- resolver 字段解析: 1638 条，WARN 0 条，FAIL 0 条
...
- LH-FIN-pe_ttm PASS: pe_ttm availability。证据：non_null=2755868, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-pb PASS: pb availability。证据：non_null=3672873, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-stock_pb_q_5y PASS: stock_pb_q_5y availability。证据：non_null=3672873, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-stock_pb_q_10y PASS: stock_pb_q_10y availability。证据：non_null=3672873, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-stock_pb_q_blended PASS: stock_pb_q_blended availability。证据：non_null=3672873, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-stock_pe_ttm_q_5y PASS: stock_pe_ttm_q_5y availability。证据：non_null=2755868, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-stock_pe_ttm_q_10y PASS: stock_pe_ttm_q_10y availability。证据：non_null=2755868, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-stock_pe_ttm_q_blended PASS: stock_pe_ttm_q_blended availability。证据：non_null=2755868, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-industry_pb_q_5y PASS: industry_pb_q_5y availability。证据：non_null=3673918, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-industry_pb_q_10y PASS: industry_pb_q_10y availability。证据：non_null=3673918, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-industry_pb_q_blended PASS: industry_pb_q_blended availability。证据：non_null=3673918, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-industry_pe_ttm_q_5y PASS: industry_pe_ttm_q_5y availability。证据：non_null=3673918, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-industry_pe_ttm_q_10y PASS: industry_pe_ttm_q_10y availability。证据：non_null=3673918, announcement_violations=0, fallback_violations=0, fallback_days=30
- LH-FIN-industry_pe_ttm_q_blended PASS: industry_pe_ttm_q_blended availability。证据：non_null=3673918, announcement_violations=0, fallback_violations=0, fallback_days=30
...
- LH-VAL-SOURCE-001 PASS: combined_v2 resolver valuation source fields。证据：candidate_rows=1638, failures=0, warnings=0
...
- 2024-03-29 688244.sh stock_pb_q_blended: window_end=2024-03-29, max_source_date_used=2024-03-29, PASS
- 2023-05-30 002307.sz stock_pb_q_blended: window_end=2023-05-30, max_source_date_used=2023-05-30, PASS
- 2024-06-03 002668.sz stock_pb_q_blended: window_end=2024-06-03, max_source_date_used=2024-06-03, PASS
- 2024-03-07 000603.sz stock_pb_q_blended: window_end=2024-03-07, max_source_date_used=2024-03-07, PASS
- 2023-07-14 600876.sh stock_pb_q_blended: window_end=2023-07-14, max_source_date_used=2023-07-14, PASS
- 2025-09-09 603288.sh stock_pe_ttm_q_blended: window_end=2025-09-09, max_source_date_used=2025-09-09, PASS
- 2024-07-19 000987.sz stock_pe_ttm_q_blended: window_end=2024-07-19, max_source_date_used=2024-07-19, PASS
- 2023-06-08 000538.sz stock_pe_ttm_q_blended: window_end=2023-06-08, max_source_date_used=2023-06-08, PASS
- 2025-03-19 002788.sz stock_pe_ttm_q_blended: window_end=2025-03-19, max_source_date_used=2025-03-19, PASS
- 2025-05-09 002372.sz stock_pe_ttm_q_blended: window_end=2025-05-09, max_source_date_used=2025-05-09, PASS
- 2024-12-06 002855.sz industry_pb_q_blended: window_end=2024-12-06, max_source_date_used=2024-12-06, PASS
- 2025-04-08 301246.sz industry_pb_q_blended: window_end=2025-04-08, max_source_date_used=2025-04-08, PASS
- 2025-02-19 000978.sz industry_pb_q_blended: window_end=2025-02-19, max_source_date_used=2025-02-19, PASS
- 2025-05-21 000822.sz industry_pb_q_blended: window_end=2025-05-21, max_source_date_used=2025-05-21, PASS
- 2024-04-19 002201.sz industry_pb_q_blended: window_end=2024-04-19, max_source_date_used=2024-04-19, PASS
- 2024-12-06 002855.sz industry_pe_ttm_q_blended: window_end=2024-12-06, max_source_date_used=2024-12-06, PASS
- 2025-04-08 301246.sz industry_pe_ttm_q_blended: window_end=2025-04-08, max_source_date_used=2025-04-08, PASS
- 2025-02-19 000978.sz industry_pe_ttm_q_blended: window_end=2025-02-19, max_source_date_used=2025-02-19, PASS
- 2025-05-21 000822.sz industry_pe_ttm_q_blended: window_end=2025-05-21, max_source_date_used=2025-05-21, PASS
- 2024-04-19 002201.sz industry_pe_ttm_q_blended: window_end=2024-04-19, max_source_date_used=2024-04-19, PASS
