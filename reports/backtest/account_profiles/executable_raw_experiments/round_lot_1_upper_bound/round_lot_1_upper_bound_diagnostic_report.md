# round_lot_1_upper_bound 回测诊断报告
...
- 原始买入信号有 541 个，主要流失发生在执行层：可执行买入 34 个。
- 历史 effective universe 平均 24.16 只，最小 12 只，最大 33 只。
- 执行约束中，最小交易额阻断 54 次，整手阻断 0 次。
...
- 2023-11: raw_buy=8, account_feasible=8, executable_buy=4, executed_buy=2
...
- 2024-07: raw_buy=6, account_feasible=6, executable_buy=4, executed_buy=3
