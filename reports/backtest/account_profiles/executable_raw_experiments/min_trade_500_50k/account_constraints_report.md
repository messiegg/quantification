...
- status: WARN
- generated_at: 2026-05-07T04:08:03.647631+00:00
- git_commit: fcbad4f7fd70542596dcb7537dba4e7ea41a84c9
- config_hash: ccdcf0c579fce6466ac05bc404fe10a5d58634c11bf2999ab424d70144acb668

## runtime profile

- account_profile: min_trade_500_50k
...
- unique_raw_buy_intent_count: 165
- repeat_raw_buy_intent_count: 509
- repeat_raw_buy_intent_ratio: 0.755192878338279
- repeated_blocked_buy_signal_count: 509
- account_feasible_buy_signal_count: 482
- user_visible_buy_recommendation_count: 22
- user_visible_blocked_buy_count: 143
...
- executable_unique_raw_intent_ratio: 0.13333333333333333
...
- average_cash_ratio: 0.6166
- average_exposure: 0.4260
- max_exposure: 0.5546
- turnover: 81853.95
...
|---|---:|---:|---:|---:|---:|---|---|---|
| MAX_POSITIONS_LIMIT | 459 | 0.6810089020771514 | 0.7039877300613497 | 27 | 226 | defensive_dividend | 000651.sz,600018.sh,600999.sh,601211.sh,000333.sz,600803.sh,600233.sh,601021.sh,000807.sz,600036.sh | 组合已达到最大持仓数，新的买入意图被阻断。 |
| CASH_INSUFFICIENT_FOR_ONE_LOT | 151 | 0.22403560830860533 | 0.23159509202453987 | 9 | 65 | defensive_dividend | 600585.sh,000333.sz,000651.sz,600926.sh,601336.sh,601601.sh,000932.sz,600018.sh,300628.sz | 当前可用现金不足以买入一手。 |
| PRICE_TOO_HIGH_FOR_ACCOUNT_LOT | 30 | 0.04451038575667656 | 0.046012269938650305 | 2 | 27 | cyclical_rotation | 601021.sh,600309.sh | 按当前账户和单票上限，一手金额过高。 |
| PRICE_TOO_HIGH_FOR_REMAINING_CAPACITY | 11 | 0.016320474777448073 | 0.01687116564417178 | 1 | 11 | defensive_dividend | 601318.sh | 剩余单票容量不足以容纳一手或目标加仓。 |
| DAILY_NEW_POSITION_LIMIT | 1 | 0.001483679525222552 | 0.0015337423312883436 | 1 | 1 | defensive_dividend | 601318.sh | 当日新开仓数量达到上限。 |
