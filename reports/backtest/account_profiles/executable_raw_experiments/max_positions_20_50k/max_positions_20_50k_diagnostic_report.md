...
- 原始买入信号有 371 个，主要流失发生在执行层：可执行买入 38 个。
...
- 2024-09: raw_buy=109, account_feasible=6, executable_buy=4, executed_buy=4
...
- 2025-04: raw_buy=13, account_feasible=3, executable_buy=3, executed_buy=3
- 2025-05: raw_buy=6, account_feasible=1, executable_buy=1, executed_buy=1
