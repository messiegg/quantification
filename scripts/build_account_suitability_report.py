    ...
    payload = {
        ...
        **profile_meta,
        ...
        "base_case": {
            ...
            "repeat_raw_buy_intent_count": base_report.get("repeat_raw_buy_intent_count"),
            "repeat_raw_buy_intent_ratio": base_report.get("repeat_raw_buy_intent_ratio"),
            ...
            "executable_new_position_buy_count": base_report.get("executable_new_position_buy_count"),
            "executable_add_buy_count": base_report.get("executable_add_buy_count"),
            "executable_raw_buy_ratio": buy_ratio,
            "executable_unique_raw_intent_ratio": base_report.get("executable_unique_raw_intent_ratio"),
            ...
            "full_portfolio_raw_buy_intent_count": base_report.get("full_portfolio_raw_buy_intent_count"),
            "full_portfolio_raw_buy_intent_ratio": base_report.get("full_portfolio_raw_buy_intent_ratio"),
            "new_position_raw_intent_count": base_report.get("new_position_raw_intent_count"),
            "add_position_raw_intent_count": base_report.get("add_position_raw_intent_count"),
            "blocker_counts": blocker_counts,
            "block_reason_breakdown": base_report.get("block_reason_breakdown", []),
            "metric_denominators": base_report.get("metric_denominators", {}),
            ...
            "cash_liquidity_block_ratio": base_report.get("cash_liquidity_block_ratio"),
...
def _write_md(payload: dict[str, Any], path_like: str | Path = OUT_MD) -> None:
    ...
    lines = [
        ...
        *runtime_profile_lines(payload),
        ...
        f"- repeat_raw_buy_intent_count: {base.get('repeat_raw_buy_intent_count')}",
        f"- repeat_raw_buy_intent_ratio: {base.get('repeat_raw_buy_intent_ratio')}",
        ...
        f"- executable_new_position_buy_count: {base.get('executable_new_position_buy_count')}",
        f"- executable_add_buy_count: {base.get('executable_add_buy_count')}",
        f"- executable_raw_buy_ratio: {base['executable_raw_buy_ratio']}",
        f"- executable_unique_raw_intent_ratio: {base.get('executable_unique_raw_intent_ratio')}",
        ...
        f"- full_portfolio_raw_buy_intent_count: {base.get('full_portfolio_raw_buy_intent_count')}",
        f"- full_portfolio_raw_buy_intent_ratio: {base.get('full_portfolio_raw_buy_intent_ratio')}",
        f"- new_position_raw_intent_count: {base.get('new_position_raw_intent_count')}",
        f"- add_position_raw_intent_count: {base.get('add_position_raw_intent_count')}",
        ...
        f"- cash_block_ratio: {base['cash_block_ratio']} (direct CASH_INSUFFICIENT only)",
        f"- cash_liquidity_block_ratio: {base.get('cash_liquidity_block_ratio')} (cash + one-lot cash blockers)",
