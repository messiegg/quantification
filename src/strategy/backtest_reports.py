...
DAILY_FUNNEL_COLUMNS = [
    ...
    "execution_status_executable_count",
    "execution_status_watch_count",
    "execution_status_pending_count",
    "execution_status_blocked_count",
    "execution_status_no_action_count",
    "execution_reason_watch_portfolio_full_count",
    "execution_reason_watch_compact_rank_out_count",
    "execution_reason_pending_cash_one_lot_count",
    "execution_reason_pending_lot_accumulation_required_count",
    "execution_reason_block_price_too_high_for_account_lot_count",
